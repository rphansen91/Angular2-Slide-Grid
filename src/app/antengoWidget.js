...
var AntengoWidget = (function () {
    function AntengoWidget(partnersService, listingParams, slideItems, slidePositions, listingGrid, customizations, element) {
        var _this = this;
        ...
        AntengoWidget.display.listingParams
            ...
            AntengoWidget.display.listings = listings.splice(0, 300 - (300 % _this.listingGrid.columns))
                .map(function (listing, index) {
                listing.top = _this.listingGrid.getTop(index);
                listing.left = _this.listingGrid.getLeft(index);
                return listing;
            });
    ...
    AntengoWidget = __decorate([
        angular2_1.Component({
            ...
            providers: [listingParams_1.ListingParams, partners_service_1.PartnersService, angular2_1.ElementRef, listingDisplay_1.ListingGrid],
        ...
        __metadata('design:paramtypes', [partners_service_1.PartnersService, listingParams_1.ListingParams, slideShow_1.SlideItems, slidePositions_1.SlidePositions, listingDisplay_1.ListingGrid, customizations_service_1.Customizations, angular2_1.ElementRef])
    ], AntengoWidget);
