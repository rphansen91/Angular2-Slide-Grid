...
var SlowScroll = (function () {
    ...
    __decorate([
        worker_1.Input('direction'), 
        __metadata('design:type', Number)
    ], SlowScroll.prototype, "direction", void 0);
    SlowScroll = __decorate([
        worker_1.Directive({
            selector: "slow-scroll",
            inputs: ["direction: direction"],
            providers: [worker_1.ElementRef]
        }),
        __param(0, worker_1.Inject(worker_1.ElementRef)), 
        __metadata('design:paramtypes', [worker_1.ElementRef])
    ], SlowScroll);
    return SlowScroll;
})();
